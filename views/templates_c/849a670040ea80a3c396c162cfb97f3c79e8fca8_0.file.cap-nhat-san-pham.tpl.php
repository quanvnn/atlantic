<?php
/* Smarty version 3.1.29, created on 2016-09-28 14:22:48
  from "/home/lequan/IMAD/atlantic/views/templates/admin/cap-nhat-san-pham.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_57eb6fc8a05e71_76433596',
  'file_dependency' => 
  array (
    '849a670040ea80a3c396c162cfb97f3c79e8fca8' => 
    array (
      0 => '/home/lequan/IMAD/atlantic/views/templates/admin/cap-nhat-san-pham.tpl',
      1 => 1474966765,
      2 => 'file',
    ),
  ),
...
function content_57eb6fc8a05e71_76433596 ($_smarty_tpl) {
...
$_smarty_tpl->ext->_inheritance->processBlock($_smarty_tpl, 0, 'content', array (
  0 => 'block_167173638057eb6fc89efd37_56353984',
  1 => false,
  3 => 0,
  2 => 0,
));
...
/* {block 'content'}  file:admin/cap-nhat-san-pham.tpl */
function block_167173638057eb6fc89efd37_56353984($_smarty_tpl, $_blockParentStack) {
?>
...
<div id="page-wrapper">
	...
	<div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">CẬP NHẬT SÁCH</h3>
        </div>  	
  		<div class="col-sm-8">
...
" placeholder="Ví dụ: Think and grow rich">
		  	...
		  	<div class="col-sm-6 col-sm-offset-1">
		  		<fieldset class="form-group">
		  			<label>Tên uri <?php echo $_smarty_tpl->tpl_vars['mangErr']->value['ten_san_pham_url'];?>
</label>
			...
			<div class="col-sm-6 col-sm-offset-1">
				<fieldset class="form-group">
					<label>Ảnh bìa sách <?php echo $_smarty_tpl->tpl_vars['mangErr']->value['hinh'];?>
				  	...
				  	<small class="text-muted">Lưu ý: Hình phải đảm bảo kích thước 200 x 300 px.</small>
				</fieldset>
			</div>
...
?>				    	
			...
			<div class="col-sm-2">
				<fieldset class="form-group">
				  	<input type="submit" class="btn btn-primary" name="btnCapNhatSanPham" value="Cập Nhật">
				</fieldset>
			</div>
		</div>
	</div>
